...
exports.libs = libs;
exports.default = series(clean, parallel(html, css, imgCopy, fontsCopy, javaScript, libs, serve));
exports.public = series(clean, imgOptimization, 
  parallel(html, cssPublic, imgCopy, fontsCopy, jsPublic, libs, serve));
